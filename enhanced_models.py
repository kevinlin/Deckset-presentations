"""
Enhanced data models for the Deckset Website Generator.

This module defines enhanced data structures for comprehensive Deckset markdown
processing, including advanced layout features, media processing, and configuration.
"""
...
class EnhancedPresentation:
    ...
    info: Any  # Will be PresentationInfo from models.py
